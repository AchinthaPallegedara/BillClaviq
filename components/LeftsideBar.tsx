...
const LeftsideBar = () => {
  return (
    <div className="hidden lg:flex fixed bottom-0 start-0 z-50 h-full w-[270px] border-e-2 border-gray-100 bg-white dark:bg-black 2xl:w-72 dark:border-zinc-800">
